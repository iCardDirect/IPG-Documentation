...
* [IPG API](https://dev-direct.icards.eu/sandbox/public/documents/IPG_API.pdf) - This document describes the interface for e-commerce payments via payment gateway
